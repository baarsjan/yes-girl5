...
const HeroSection = () => (
    <section id="home" className="relative min-h-screen flex items-end justify-start overflow-hidden pb-32">
      <div className="absolute inset-0">
        <img 
          src="/4X5-GAVIN-VIANO-1536x1920.jpg" 
          alt="Theatre Show" 
      ...
      <div className="relative z-10 text-left px-6 max-w-lg">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
          <span className="relative inline-block animate-title-entrance">
            {/* Animated gradient line */}
            <div className="absolute -left-8 top-1/2 -translate-y-1/2 h-0.5 bg-gradient-to-r from-[#eb3d92] to-purple-500 animate-line-draw opacity-0"></div>
            
            {/* Individual letter images with animations */}
            <div className="flex items-center -space-x-1">
              <img
                src="/YesGirlLetters/Y.png"
                alt="Y"
                className="animated-letter-image h-8 md:h-10 w-auto object-contain"
                style={{ animationDelay: '0.1s' }}
              />
              <img
                src="/YesGirlLetters/E.png"
                alt="E"
                className="animated-letter-image h-8 md:h-10 w-auto object-contain -ml-0.5"
                style={{ animationDelay: '0.2s' }}
              />
              <img
                src="/YesGirlLetters/S.png"
                alt="S"
                className="animated-letter-image h-8 md:h-10 w-auto object-contain -ml-0.5"
                style={{ animationDelay: '0.3s' }}
              />
              <img
                src="/YesGirlLetters/-.png"
                alt="-"
                className="animated-letter-image h-8 md:h-10 w-auto object-contain -ml-1"
                style={{ animationDelay: '0.4s' }}
              />
              <img
                src="/YesGirlLetters/G.png"
                alt="G"
                className="animated-letter-image h-8 md:h-10 w-auto object-contain -ml-1"
                style={{ animationDelay: '0.5s' }}
              />
              <img
                src="/YesGirlLetters/I.png"
                alt="I"
                className="animated-letter-image h-8 md:h-10 w-auto object-contain -ml-0.5"
                style={{ animationDelay: '0.6s' }}
              />
              <img
                src="/YesGirlLetters/R.png"
                alt="R"
                className="animated-letter-image h-8 md:h-10 w-auto object-contain -ml-0.5"
                style={{ animationDelay: '0.7s' }}
              />
              <img
                src="/YesGirlLetters/L.png"
                alt="L"
                className="animated-letter-image h-8 md:h-10 w-auto object-contain -ml-0.5"
            ...
            {/* Animated underline */}
            <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-[#eb3d92] to-purple-500 animate-underline-expand"></div>
            
            {/* Floating particles around title */}
            <div className="absolute -top-4 -left-2 w-2 h-2 bg-[#eb3d92] rounded-full animate-particle-float opacity-60"></div>
            <div className="absolute -top-6 right-8 w-1 h-1 bg-purple-400 rounded-full animate-particle-float-delayed opacity-80"></div>
            <div className="absolute -bottom-6 right-4 w-3 h-3 bg-[#eb3d92] rounded-full animate-particle-bounce opacity-50"></div>
            <div className="absolute top-2 -right-4 w-1 h-1 bg-purple-300 rounded-full animate-particle-twinkle opacity-70"></div>
          </span>
        </h1>
        <p className="text-[#eb3d92] text-lg mb-8 leading-relaxed font-lubalin font-normal italic">
          Eclectic and infectious performance about toxic love.
        </p>
        
        <div className="space-y-4 mb-8">
          
            <a href="#dates" className="flex items-center space-x-2 text-white">
  <Calendar size={16} />
  <span className="text-sm font-lubalin font-light">Dates</span>
</a>
          
          <div className="flex items-center space-x-2 text-white">
            <Clock size={16} />
            <span className="text-sm font-lubalin font-light">30 minutes</span>
          </div>
          <div className="flex items-center space-x-2 text-white">
            <MapPin size={16} />
            <span className="text-sm font-lubalin font-light">De Parade; Rotterdam, Utrecht, Amsterdam</span>
          </div>
        </div>
      </div>
    </section>
